  ...
  const categories: ReportCategoryItem[] = [
    {
      id: 'FUEL_SALES',
      title: 'Fuel Sales',
      description: 'Daily petrol and diesel cash sales records and dispenser logs.',
      icon: Droplet,
      color: 'bg-red-600',
    },
    {
      ...
      description: 'Tanker deliveries received, invoice costs, and supplier logs.',
      icon: Truck,
    ...
    },
    {
      ...
      description: 'Underground tank capacities, dip measurements, and fuel levels.',
      icon: Container,
      color: 'bg-amber-600',
    },
    {
      id: 'TANK_STOCK',
      title: 'Tank Stock',
      description: 'Current fuel volumes, dip readings, and percentage fullness.',
      icon: Container,
      color: 'bg-orange-600',
    },
    {
      id: 'SHORTAGE',
      title: 'Fuel Shortage',
      description: 'Tanker delivery shortages, expected vs actual dip discrepancies.',
      icon: Droplet,
      color: 'bg-rose-600',
    },
    {
      id: 'LUBRICANTS',
      title: 'Lubricants',
      description: 'Engine oil inventory stock, sales pricing, and low stock audit.',
      icon: Package,
      color: 'bg-purple-600',
    },
    {
      id: 'CREDIT_CARD',
      title: 'Credit Card',
      description: 'POS credit card transactions, terminal slips, and sales total.',
      icon: CreditCard,
      color: 'bg-blue-700',
    },
    {
      id: 'INFINI_CARD',
      title: 'Infinity Card',
      description: 'Infini fleet card transactions, corporate accounts, and liters.',
      icon: CreditCard,
      color: 'bg-indigo-700',
    },
    {
      ...
      description: 'Worker profiles directory, designations, and basic salaries.',
      icon: Users,
      color: 'bg-teal-600',
    },
    {
      id: 'ATTENDANCE',
      title: 'Attendance',
      description: 'Worker attendance records, shift logs, and overtime hours.',
      icon: CalendarCheck,
      color: 'bg-cyan-600',
    },
    {
      id: 'SALARY',
      title: 'Salary',
      description: 'Worker salary disbursements, advances, and ledger history.',
      icon: Banknote,
      color: 'bg-green-600',
    },
    {
      ...
      description: 'Worker salary advance vouchers and emergency payouts.',
      icon: Banknote,
      color: 'bg-lime-600',
    },
    {
    ...
    },
    {
      id: 'DAILY_CASH',
      title: 'Daily Cash',
      description: 'Daily cash register receipts, collections, and float balance.',
      icon: Wallet,
      color: 'bg-indigo-600',
    },
    {
      id: 'EXPENSES',
      title: 'Expenses',
      description: 'Station operational expenses, utility bills, and vouchers.',
      icon: Receipt,
      color: 'bg-rose-700',
    },
    {
      id: 'BANK',
      title: 'Bank',
      description: 'Bank account balances, deposits, withdrawals, and bank ledger.',
      icon: Building2,
      color: 'bg-slate-700',
    },
    {
      id: 'TAXES',
      title: 'Tax',
      description: 'Government taxes, levies, and official tax payment vouchers.',
      icon: ShieldCheck,
      color: 'bg-violet-700',
    },
    {
      id: 'CAR_WASH',
      title: 'Car Wash',
      description: 'Car wash services, vehicle packages, and service revenues.',
      icon: Car,
      color: 'bg-sky-600',
    },
    {
      id: 'TYRE_SHOP',
      title: 'Tire Shop',
      description: 'Tire repair services, wheel alignment, and technician logs.',
      icon: CircleDot,
      color: 'bg-zinc-700',
    },
    {
      id: 'TUCK_SHOP',
      title: 'Tuck Shop',
      description: 'Mart inventory catalog, retail stock valuation, and items.',
      icon: ShoppingBag,
      color: 'bg-amber-800',
    },
    {
      id: 'RESTAURANT',
      title: 'Restaurant',
      description: 'Fast food sales receipts, customer orders, and revenue.',
      icon: ChefHat,
      color: 'bg-red-700',
    },
    {
